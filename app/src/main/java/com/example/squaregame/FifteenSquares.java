...
public class FifteenSquares extends SurfaceView implements View.OnClickListener, View.OnTouchListener {
    //variables
    Paint boardPaint = new Paint(Color.BLUE);
    Paint numPaint = new Paint();
    int[][] Squares = new int[4][4];
    static int numOfSquares = 15; //numbers
    static int length = 4;
    int startX;
    int startY;
    int endX;
    ...
    public FifteenSquares(Context context, AttributeSet attrsSet)
    {
